...
public class UsuarioController {
	...
	public String listar(@RequestParam(required = false) Boolean mostrarTodos,
			@RequestParam(required = false) Integer rolId, Model model) {
	...
	public String editar(@PathVariable Integer id, @RequestParam(required = false) Integer rolId,
			@RequestParam(required = false) Boolean mostrarTodos, Model model) {
		Usuario t = trabajadorService.buscarPorId(id);
		if (t == null) {
			return "redirect:/web/trabajadores";
		}
		t.setContra(""); // Limpiar password para evitar enviar el hash a la vista
		model.addAttribute("trabajador", t);
	...
	@PostMapping("/guardar")
	public String guardar(@ModelAttribute Usuario trabajador, @RequestParam(required = false) Integer filtroRolId,
	...
	public String eliminar(@PathVariable Integer id, @RequestParam(required = false) Integer rolId,
